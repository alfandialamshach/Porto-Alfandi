        ...
        {experiencesData.map((item, index) => (
          <React.Fragment key={index}>
            <VerticalTimelineElement
              ...
              contentStyle={{
                background:
                  theme === "light" ? "#f3f4f6" : "rgba(15, 23, 42, 0.8)",
                boxShadow:
                  theme === "light" ? "none" : "0 8px 30px rgba(0, 0, 0, 0.4)",
                border:
                  theme === "light"
              ...
              contentArrowStyle={{
                borderRight:
                  theme === "light"
                    ? "0.4rem solid #9ca3af"
                    : "0.4rem solid rgba(56, 189, 248, 0.4)",
              }}
              date={item.date}
              icon={item.icon}
              iconStyle={{
                ...
                color: theme === "light" ? "#111827" : "#38bdf8",
                border: theme === "light" ? "none" : "2px solid #38bdf8",
                fontSize: "1.5rem",
              }}
            >
